...
if (!HMAC_PEPPER_RAW) {
  console.error("FATAL: DLP_HMAC_PEPPER environment variable is not set. Aborting.");
}
...
if (!MASTER_KEK_RAW) {
  console.error("FATAL: DLP_MASTER_KEK environment variable is not set. Aborting.");
}
