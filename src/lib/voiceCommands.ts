...
const arabicNavCommands: NavDef[] = [
  ...
  { type: 'navigate_module', keywords: ['افتح التعرف الذكي', 'التعرف الذكي', 'توجيه المستندات', 'افتح توجيه المستندات', 'روح التعرف الذكي', 'التعرف الضوئي', 'الـ OCR'], target: 'document-recognition' },
  ...
  { type: 'navigate_module', keywords: ['افتح محرر المستندات', 'محرر المستندات', 'استوديو المستندات', 'افتح استوديو المستندات', 'روح محرر المستندات', 'تحرير المستندات', 'المستندات السيادية'], target: 'document-studio' },
...
const englishNavCommands: NavDef[] = [
  ...
  { type: 'navigate_module', keywords: ['open document recognition', 'document recognition', 'OCR routing', 'open OCR', 'go to recognition', 'show recognition', 'smart routing'], target: 'document-recognition' },
  ...
  { type: 'navigate_module', keywords: ['open document studio', 'document studio', 'sovereign editor', 'open editor', 'go to documents', 'show document studio', 'document editing'], target: 'document-studio' },
...
const frenchNavCommands: NavDef[] = [
  ...
  { type: 'navigate_module', keywords: ['ouvrir reconnaissance documents', 'reconnaissance intelligente documents', 'aller reconnaissance'], target: 'document-recognition' },
  ...
  { type: 'navigate_module', keywords: ['ouvrir studio documents', 'studio documents souverain', 'aller studio'], target: 'document-studio' },
