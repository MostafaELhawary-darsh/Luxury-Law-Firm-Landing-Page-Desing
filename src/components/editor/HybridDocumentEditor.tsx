...
const HybridDocumentEditor: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white dir-rtl">
      ...
      {/* Toolbar */}
      <div className="bg-slate-700/50 backdrop-blur border-b border-slate-600 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-6 py-3">
          <div className="flex items-center gap-2 flex-wrap">
            {/* Upload Buttons */}
            <label className="flex items-center gap-2 px-4 py-2 bg-slate-600 hover:bg-slate-500 rounded-lg cursor-pointer transition-colors">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="bg-white rounded-lg shadow-2xl overflow-hidden min-h-96">
          <EditorContent editor={editor} className="prose prose-invert max-w-none p-8" />
        </div>
      </main>
