...
const JudicialAgenda = lazy(() => import('./JudicialAgenda'));
const ClientManagement = lazy(() => import('./ClientManagement'));
const PowerOfAttorney = lazy(() => import('./PowerOfAttorney'));
const TaskManagement = lazy(() => import('./TaskManagement'));
const SmartCaseCore = lazy(() => import('./SmartCaseCore'));
const StaffManagement = lazy(() => import('./StaffManagement'));
const BankingManagement = lazy(() => import('./BankingManagement'));
const MeetingManagement = lazy(() => import('./MeetingManagement'));
const LegalTracker = lazy(() => import('./LegalTracker'));
const LegalTalent = lazy(() => import('./LegalTalent'));
const LawyersCockpit = lazy(() => import('./LawyersCockpit'));
const LaaSPlatform = lazy(() => import('./LaaSPlatform'));
const PermissionsManagement = lazy(() => import('./PermissionsManagement'));
const DocumentManagement = lazy(() => import('./DocumentManagement'));
const InternalTaskEngine = lazy(() => import('./InternalTaskEngine'));
const OmniAgent = lazy(() => import('./OmniAgent'));
const SovereignMail = lazy(() => import('./SovereignMail'));
const PredictiveRiskEngine = lazy(() => import('./PredictiveRiskEngine'));
const CivilCommercial = lazy(() => import('./CivilCommercial'));
const AdministrativeCourt = lazy(() => import('./AdministrativeCourt'));
const StateCouncil = lazy(() => import('./StateCouncil'));
const EconomicCourt = lazy(() => import('./EconomicCourt'));
const FamilyCourt = lazy(() => import('./FamilyCourt'));
const LaborCourt = lazy(() => import('./LaborCourt'));
const Arbitration = lazy(() => import('./Arbitration'));
const DisputeCommittees = lazy(() => import('./DisputeCommittees'));
const ExecutionEngine = lazy(() => import('./ExecutionEngine'));
const TrademarkEngine = lazy(() => import('./TrademarkEngine'));
const PatentEngine = lazy(() => import('./PatentEngine'));
const CopyrightEngine = lazy(() => import('./CopyrightEngine'));
const CyberSecurityEngine = lazy(() => import('./CyberSecurityEngine'));
const CyberCrimeEngine = lazy(() => import('./CyberCrimeEngine'));
const DigitalSignatureEngine = lazy(() => import('./DigitalSignatureEngine'));
const DigitalPublishingEngine = lazy(() => import('./DigitalPublishingEngine'));
const DigitalAssetEngine = lazy(() => import('./DigitalAssetEngine'));
const CommercialContractEngine = lazy(() => import('./CommercialContractEngine'));
const MergerAcquisitionEngine = lazy(() => import('./MergerAcquisitionEngine'));
const FDIEngine = lazy(() => import('./FDIEngine'));
const RealEstateEngine = lazy(() => import('./RealEstateEngine'));
const DistributionEngine = lazy(() => import('./DistributionEngine'));
const MaritimeCommerceEngine = lazy(() => import('./MaritimeCommerceEngine'));
const StrategicFinanceEngine = lazy(() => import('./StrategicFinanceEngine'));
const AntitrustEngine = lazy(() => import('./AntitrustEngine'));
const InheritanceEngine = lazy(() => import('./InheritanceEngine'));
const EndowmentEngine = lazy(() => import('./EndowmentEngine'));
const CivilContractsEngine = lazy(() => import('./CivilContractsEngine'));
const CompensationEngine = lazy(() => import('./CompensationEngine'));
const JointPropertyEngine = lazy(() => import('./JointPropertyEngine'));
const OralContractsEngine = lazy(() => import('./OralContractsEngine'));
const RealEstateSecurityEngine = lazy(() => import('./RealEstateSecurityEngine'));
const ConsularAffairsEngine = lazy(() => import('./ConsularAffairsEngine'));
const CustomsTaxEngine = lazy(() => import('./CustomsTaxEngine'));
const EnvironmentalEngine = lazy(() => import('./EnvironmentalEngine'));
const EnergyResourcesEngine = lazy(() => import('./EnergyResourcesEngine'));
const ConsumerProtectionEngine = lazy(() => import('./ConsumerProtectionEngine'));
const SportsEngine = lazy(() => import('./SportsEngine'));
const AcademicEngine = lazy(() => import('./AcademicEngine'));
const PreUniversityEngine = lazy(() => import('./PreUniversityEngine'));
const LocalAdministrationEngine = lazy(() => import('./LocalAdministrationEngine'));
const TransportLogisticsEngine = lazy(() => import('./TransportLogisticsEngine'));
const AdministrativeGovernanceEngine = lazy(() => import('./AdministrativeGovernanceEngine'));
const InternalInvestigationsEngine = lazy(() => import('./InternalInvestigationsEngine'));
const KnowledgeManagementEngine = lazy(() => import('./KnowledgeManagementEngine'));
const IntegratedDocumentEngine = lazy(() => import('./IntegratedDocumentEngine'));
const BulkArchiverEngine = lazy(() => import('./BulkArchiverEngine'));
const BoardroomGovernanceEngine = lazy(() => import('./BoardroomGovernanceEngine'));

const SovereignStorageEngine = lazy(() => import('./SovereignStorageEngine'));
const AudioTranscriptionEngine = lazy(() => import('./AudioTranscriptionEngine'));
const WellnessEngine = lazy(() => import('./WellnessEngine'));
const SyndicatesEngine = lazy(() => import('./SyndicatesEngine'));
const MedicalInstitutionsEngine = lazy(() => import('./MedicalInstitutionsEngine'));
const EngineeringConsultingEngine = lazy(() => import('./EngineeringConsultingEngine'));
const EconomicInvestmentEngine = lazy(() => import('./EconomicInvestmentEngine'));
const EmbassiesConsularEngine = lazy(() => import('./EmbassiesConsularEngine'));
const CrossBorderContractsEngine = lazy(() => import('./CrossBorderContractsEngine'));
const InternationalOrganizationsEngine = lazy(() => import('./InternationalOrganizationsEngine'));
const NGOsCivilSocietyEngine = lazy(() => import('./NGOsCivilSocietyEngine'));
const SocialInsuranceEngine = lazy(() => import('./SocialInsuranceEngine'));
const LaborRelationsEngine = lazy(() => import('./LaborRelationsEngine'));
const PressMediaEngine = lazy(() => import('./PressMediaEngine'));
const BankingFinanceEngine = lazy(() => import('./BankingFinanceEngine'));
const InHouseLegalEngine = lazy(() => import('./InHouseLegalEngine'));
const HumanResourcesEngine = lazy(() => import('./HumanResourcesEngine'));
const CompoundHOAEngine = lazy(() => import('./CompoundHOAEngine'));
const SportsClubsEngine = lazy(() => import('./SportsClubsEngine'));
const FamilyWelfareEngine = lazy(() => import('./FamilyWelfareEngine'));
const MediaProductionEngine = lazy(() => import('./MediaProductionEngine'));
const TelecomITDataEngine = lazy(() => import('./TelecomITDataEngine'));
const RealEstateAssetEngine = lazy(() => import('./RealEstateAssetEngine'));
const RailwaysMetroEngine = lazy(() => import('./RailwaysMetroEngine'));
const LegalAccountingEngine = lazy(() => import('./LegalAccountingEngine'));
const TourismHotelsEngine = lazy(() => import('./TourismHotelsEngine'));
const IndustrialSectorEngine = lazy(() => import('./IndustrialSectorEngine'));
const WholesaleRetailEngine = lazy(() => import('./WholesaleRetailEngine'));
const PrivateSecurityEngine = lazy(() => import('./PrivateSecurityEngine'));
const ImportExportEngine = lazy(() => import('./ImportExportEngine'));
const HealthSafetyEngine = lazy(() => import('./HealthSafetyEngine'));
const MarketingAdsEngine = lazy(() => import('./MarketingAdsEngine'));
const AutomotiveTradeEngine = lazy(() => import('./AutomotiveTradeEngine'));
const AutomotiveManufacturingEngine = lazy(() => import('./AutomotiveManufacturingEngine'));
const FertilizersChemicalsEngine = lazy(() => import('./FertilizersChemicalsEngine'));
const ForeignResidencyEngine = lazy(() => import('./ForeignResidencyEngine'));
const CapitalMarketsEngine = lazy(() => import('./CapitalMarketsEngine'));
const ShoppingMallEngine = lazy(() => import('./ShoppingMallEngine'));
const LibraryArchiveEngine = lazy(() => import('./LibraryArchiveEngine'));
const MaintenanceWarrantyEngine = lazy(() => import('./MaintenanceWarrantyEngine'));
const IntegrationSynergyEngine = lazy(() => import('./IntegrationSynergyEngine'));
const QuarriesMiningEngine = lazy(() => import('./QuarriesMiningEngine'));
const CeramicsPorcelainEngine = lazy(() => import('./CeramicsPorcelainEngine'));
const ArbitrationHubEngine = lazy(() => import('./ArbitrationHubEngine'));
const FoodSecurityEngine = lazy(() => import('./FoodSecurityEngine'));
const IoTBridgeEngine = lazy(() => import('./IoTBridgeEngine'));
const DisasterRecoveryEngine = lazy(() => import('./DisasterRecoveryEngine'));
const BiometricGatewayEngine = lazy(() => import('./BiometricGatewayEngine'));
const VaultConnectorEngine = lazy(() => import('./VaultConnectorEngine'));
const SwarmIntelligenceEngine = lazy(() => import('./SwarmIntelligenceEngine'));
const NeuralMemoryEngine = lazy(() => import('./NeuralMemoryEngine'));
const SovereignDelegationEngine = lazy(() => import('./SovereignDelegationEngine'));
const CriminalLawEngine = lazy(() => import('./CriminalLawEngine'));
const MOJIntegrationEngine = lazy(() => import('./MOJIntegrationEngine'));
const CorporateGovernanceEngine = lazy(() => import('./CorporateGovernanceEngine'));
const CrisisManagementEngine = lazy(() => import('./CrisisManagementEngine'));
const HSEInternalEngine = lazy(() => import('./HSEInternalEngine'));
const QualityAssuranceEngine = lazy(() => import('./QualityAssuranceEngine'));
const FreeProfessionsEngine = lazy(() => import('./FreeProfessionsEngine'));
const CorporateCommercialEngine = lazy(() => import('./CorporateCommercialEngine'));
const GenOfficeEditorEngine = lazy(() => import('./GenOfficeEditorEngine'));
const SmartGeoLocationEngine = lazy(() => import('./SmartGeoLocationEngine'));

interface FirmPageProps {
  onBackToSite: () => void;
  initialModule?: FirmModuleId | null;
...
export default function FirmManagement({ onBackToSite, initialModule, pendingAdd, consumePendingAdd }: FirmPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-8">
        <Suspense fallback={<div className="flex items-center justify-center py-20"><div className="w-8 h-8 border-3 border-gold/30 border-t-gold rounded-full animate-spin" /></div>}>
