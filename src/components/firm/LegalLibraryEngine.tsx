...
import ResultsTable, { type ResultRow } from '@/components/library/ResultsTable';
import DocumentDetail from '@/components/library/DocumentDetail';
import LawIndexView from '@/components/library/LawIndexView';
import SubjectIndexView from '@/components/library/SubjectIndexView';

const supabaseUrl = import.meta.env.VITE_SUPABASE_URL;
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY;
const supabase = createClient(supabaseUrl, supabaseAnonKey);

export default function LegalLibraryEngine() {
  ...
  if (!section) {
    return (
      <div className="p-4 lg:p-6">
        <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between rounded-lg mb-6">
