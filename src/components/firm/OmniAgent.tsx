...
import {
  ...
  Wheat, Fingerprint, Vault, BrainCircuit,
} from 'lucide-react';
...
const EXAMPLE_COMMANDS = [
  ...
  'فكك أمر تأسيس مصنع أدوية وتأمين شحنة مواد خام إلى مهام قطاعية موازية',
  'حلل الروابط العصبية بين الحكم التجاري الأخير والعقود المالية في الأرشيف',
  'فعّل بروتوكول التفويض السيادي لفتح ملف الاستحواذ فائق السرية بعد فشل البصمة',
  'حلل اتفاقية التمويل المعروضة وربطها بميزانية المشروع في المحرك المالي',
  'صغ عقد رعاية رياضي مع الشركة X مع مراعاة بنود اللعب المالي النظيف',
  'راجع ملف ترقية الأستاذ X ومطابقتها لقرارات المجلس الأعلى للجامعات',
  'راجع قائمة المصروفات الدراسية المقترحة وتأكد من مطابقتها لنسب الزيادة القانونية',
  'استخرج ترخيص بناء لمشروع جديد وتأكد من مطابقة خطوط التنظيم',
];
